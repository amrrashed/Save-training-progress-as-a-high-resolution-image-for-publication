...
%%cross validation
%load images
digitDatasetPath = fullfile('D:\covid project\ADATASETS\moddataset');
...
%     augtestimds = augmentedImageDatastore([224 224],imdsTest);
   ...
   % [predicted_labels(test_idx),posterior(test_idx,:)] = classify(netTransfer,augtestimds);
    ...
    save(sprintf('vgg16_%d_among_%d_folds',fold_idx,num_folds),'netTransfer','test_idx','train_idx','labeltest','labeltrain');
     delete(findall(0))
