...
x=fix(clock);
     ...
     print(NNET_CNN(end),strcat('training_noaug_vgg16_dpi600',num2str(x(5))),'-dpng','-r600');
      ...
      print(NNET_CNN(end),strcat('training_noaug_vgg16_dpi1000',num2str(x(5))),'-dpng','-r1000');
end
end
% function stop=savetrainingplot(info)
% stop=false;  %prevents this function from ending trainNetwork prematurely
